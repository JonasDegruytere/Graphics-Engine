...
/**
 * \brief The namespace of the INI 2D configuration file parser.
 */
namespace ini
{
        /**
         * \brief The base class for all exceptions that are thrown by the INI 2D-parser.
         */
        ...
        /**
         * \brief The class that represents an entry in the section of an INI 2D configuration.
         */
        class Entry
        {
                private:
        ...
        class Configuration
        {
                private:
                        ...
                        /**
                         * \brief Constructs an INI 2D configuration by copying another one.
                         *
                         * This copy-assignment operator is made private in order to avoid copying.
                         * INI 2D configurations should not be copied, they should be passed by reference
                         * instead.
                         *
                         * \param original The INI 2D configuration that is copied.
                         */
                        Configuration(const Configuration &original);

                        /**
                         * \brief Copies an INI 2D configuration.
                         *
                         * This copy-assignment operator is made private in order to avoid copying.
                         * INI 2D configurations should not be copied, they should be passed by reference
                         * instead.
                         ...
                         * \param original The INI 2D configuration that is copied.
                         *
                         * \return A reference to this INI 2D configuration.
                         */
