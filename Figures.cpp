...
Figure Figures::getTetrahedronFigure() {
    Figure* tetrahedronFigure = new Figure;
...
Figure Figures::getOctahedronFigure() {
    Figure* octahedronFigure = new Figure;
...
Figure Figures::getIcosahedronFigure() {
    Figure* icosahedronFigure = new Figure;
...
Figure Figures::getDodecahedronFigure() {
    Figure* dodecahedronFigure = new Figure;
    Figure icosahedronFigure = getIcosahedronFigure();
    double x, y, z;
    for (int i = 0; i < 20; ++i){
